	...
	robot.respond /(introduce )(.*)/i, (msg) ->
		...
		if msg.match[2] == 'me'
		  ...
		  introducehearsay()
			...
			msg.send "@MyriadTruths is the CEO of (sinistar)SinCo Industries, the longest serving member of the [ALLIN] Team Management Group, and most importantly, my creator. (content)"
